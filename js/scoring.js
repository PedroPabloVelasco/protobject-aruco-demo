...
export function computeScores(){
  ...
  const NS = { car:count(state.NS,'auto'), bike:count(state.NS,'bici'),
               bus:count(state.NS,'bus'), ped:state.pedRequests, amb:count(state.NS,'ambulancia') };
  const EW = { car:count(state.EW,'auto'), bike:count(state.EW,'bici'),
               bus:count(state.EW,'bus'), ped:state.pedRequests, amb:count(state.EW,'ambulancia') };
